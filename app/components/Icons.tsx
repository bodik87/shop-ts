  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none">
      <path
        ...
        strokeLinejoin="round"
        strokeWidth="2"
        d="M9 5.6c0-.56 0-.84.109-1.054a1 1 0 0 1 .437-.437C9.76 4 10.04 4 10.6 4h2.8c.56 0 .84 0 1.054.109a1 1 0 0 1 .437.437C15 4.76 15 5.04 15 5.6v2.8c0 .56 0 .84-.109 1.054a1 1 0 0 1-.437.437C14.24 10 13.96 10 13.4 10h-2.8c-.56 0-.84 0-1.054-.109a1 1 0 0 1-.437-.437C9 9.24 9 8.96 9 8.4V5.6Zm0 10c0-.56 0-.84.109-1.054a1 1 0 0 1 .437-.437C9.76 14 10.04 14 10.6 14h2.8c.56 0 .84 0 1.054.109a1 1 0 0 1 .437.437C15 14.76 15 15.04 15 15.6v2.8c0 .56 0 .84-.109 1.054a1 1 0 0 1-.437.437C14.24 20 13.96 20 13.4 20h-2.8c-.56 0-.84 0-1.054-.109a1 1 0 0 1-.437-.437C9 19.24 9 18.96 9 18.4v-2.8Z"
      />
    </svg>
  );
}
